...
#include <Vendor/Bullet/LinearMath/btHashMap.h>

#include <Vendor/Bullet/BulletCollision/BroadphaseCollision/btQuantizedBvh.h>  //for definition of MAX_NUM_PARTS_IN_BITS
